...
const valueProps = [
  {
    icon: TrendingDown,
    title: "Finies les hausses annuelles",
    desc: "Un SaaS à 200€/mois vous coûte 7 200€ sur 3 ans. Notre application ? Entre 5 000€ et 15 000€, une seule fois. Pas d'abonnement, pas de surprise.",
  },
  {
    icon: SlidersHorizontal,
    title: "Les fonctionnalités que vous voulez, vraiment",
    desc: "Vous avez enfin un logiciel qui fait exactement ce dont vous avez besoin. Pas de menu à rallonge, pas de boutons inutiles. Juste votre métier.",
  },
  {
    icon: Code2,
    title: "Vous êtes propriétaires",
    desc: "Code source, données, hébergement — tout est à vous. Un autre développeur peut reprendre demain. Zéro dépendance du vendor.",
  },
  {
    icon: Clock,
    title: "Livrée en 4 à 8 semaines",
    desc: "Vous voyez des écrans cliquables rapidement. L'application est en production à la fin. Pas de limbo de 6 mois.",
  },
];
...
const steps = [
  {
    ...
    time: "~1 semaine",
    desc: "On traduit vos frustrations en exigences claires. Pas de brief vague — on comprend ce que l'outil doit faire pour vous.",
  },
  {
    num: "02",
    icon: Layers,
    title: "Maquette",
    time: "~1 semaine",
    desc: "Prototype cliquable, écrans réels. Vous explorez votre application avant qu'elle existe. Vous validez avant le moindre développement.",
  },
  {
    num: "03",
    icon: Hammer,
    title: "Développement",
    time: "~1-2 semaines",
    desc: "On construit. Vous testez des versions à chaque étape. Pas de tunnel noir de plusieurs mois.",
  },
  {
    num: "04",
    icon: PackageCheck,
...
const faqs = [
  {
    q: "Pourquoi choisir un dev sur mesure plutôt qu'un autre SaaS ?",
    a: "Parce qu'aucun SaaS ne fera exactement votre métier. On construit ce que vous voulez, vous avez la propriété totale, et vous arrêtez de payer au mois.",
  },
  {
    q: "Combien ça coûte ?",
    a: "Entre 5 000€ et 15 000€ selon la complexité. Prix forfaitaire — pas de surprise. Pour comparaison : votre SaaS actuel vous coûte 7 200€ à 18 000€ sur 3 ans.",
  },
  {
    q: "Et si je veux quitter votre prestataire ?",
    a: "Zéro problème. Le code, les données, l'hébergement — tout est à vous. C'est vous qui partez avec, pas nous.",
  },
  {
    q: "J'ai pas le temps de manager un projet IT.",
    a: "Vous n'avez rien à manager. On pose les questions, on propose les solutions, vous validez les étapes. Vous êtes décideur, pas PM.",
  },
  {
    q: "Comment je garantis qu'on livrera à temps ?",
    a: "Jalons clairs à chaque étape. Maquette d'abord, puis versions testables en continu. Pas de tunnel fermé.",
  },
];
    ...
    <div className={body} style={{ backgroundColor: C.bg, color: C.text }}>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <Reveal>
            <p
              ...
              style={{ color: C.amber }}
            >
              Alternative sur mesure à votre SaaS
            </p>
          </Reveal>
          <Reveal delay={100}>
            <h1 className={`${heading} text-3xl md:text-5xl lg:text-[3.5rem] leading-tight mb-6`}>
              Finissez avec votre SaaS onéreux. Accueillez votre application sur mesure.
            </h1>
          </Reveal>
          <Reveal delay={200}>
            <p className="text-lg md:text-xl leading-relaxed mb-10" style={{ color: C.textSec }}>
              Vous payez cher pour un logiciel qui ne fait pas ce que vous voulez. On crée une
              application conçue pour votre métier — à prix forfaitaire, sans abonnement.
            </p>
          </Reveal>
          <Reveal delay={300}>
            <CTA id="cta-hero" />
      ...
      <section className="px-4 md:px-8 py-16 md:py-24" style={{ backgroundColor: C.card }}>
        <div className="max-w-4xl mx-auto">
          ...
          <Reveal delay={100}>
            <p className="text-lg text-center mb-14 max-w-2xl mx-auto" style={{ color: C.textSec }}>
              On part toujours de votre problème business, pas d'un cahier des charges technique
              incompréhensible.
            </p>
          </Reveal>
        ...
        <div className="max-w-xl mx-auto">
          ...
          <Reveal delay={100}>
            <p className="text-center mb-10" style={{ color: C.textSec }}>
              15-20 minutes pour évaluer votre situation. Sans engagement.
            </p>
          </Reveal>
        ...
        <div className="max-w-2xl mx-auto">
          <Reveal>
            <p className="text-lg md:text-xl font-medium mb-8" style={{ color: C.text }}>
              Entreprise française. Code source remis à chaque projet. Prix forfaitaire garanti. Zéro SaaS.
            </p>
          </Reveal>
          <Reveal delay={100}>
            <CTA id="cta-bottom" />
...
export default LandingGoogleSaas;
