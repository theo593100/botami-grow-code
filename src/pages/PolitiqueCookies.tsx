...
const PolitiqueCookies = () => (
  <>
    <SEO
      title="Politique de gestion des cookies | Botami Software"
      description="Liste des cookies déposés sur software.botami-agency.com (mesure d'audience, publicité, fonctionnels), finalités et modalités de gestion de votre consentement."
      canonical="/politique-cookies"
    />
    <StructuredData
      data={webPageSchema({
        name: "Politique de gestion des cookies — Botami Software",
        description: "Cookies utilisés sur le site, finalités, durées et gestion du consentement.",
    ...
    <main className="min-h-screen bg-background text-foreground pt-28 pb-20 px-4 md:px-8">
      <div className="container-wide max-w-3xl mx-auto prose prose-headings:font-heading prose-headings:text-foreground prose-p:text-muted-foreground prose-li:text-muted-foreground prose-strong:text-foreground">
        ...
        <p>
          Un cookie est un petit fichier texte déposé sur votre terminal (ordinateur, tablette, smartphone) lors de votre visite sur un site. Il permet au site de reconnaître votre navigateur, de mémoriser certaines informations, et de mesurer l'audience.
        </p>
        ...
        <div className="overflow-x-auto">
          <table>
            ...
            <tbody>
              <tr><td><code>cookie_consent</code></td><td>localStorage</td><td>Mémorise le choix du bandeau cookies</td><td>Permanent tant que non effacé par l'utilisateur</td></tr>
        ...
        <div className="overflow-x-auto">
          <table>
            ...
            <tbody>
              ...
              <tr><td><code>_clck</code>, <code>_clsk</code></td><td>Microsoft Clarity</td><td>Analyser les parcours de navigation et les interactions (heatmaps, enregistrements anonymisés)</td><td>12 mois</td></tr>
        ...
        <div className="overflow-x-auto">
          <table>
            ...
            <tbody>
              ...
              <tr><td><code>NID</code>, <code>IDE</code></td><td>Google</td><td>Mesurer l'efficacité des annonces et limiter la répétition publicitaire</td><td>13 mois maximum</td></tr>
            </tbody>
          </table>
        </div>
        <p className="text-sm">
          Identifiants des comptes utilisés : Google Ads <code>AW-17963133191</code>, Google Analytics 4 <code>G-TVPD38XZ7S</code>, Microsoft Clarity <code>w8zd4ye9r8</code>.
        </p>
        ...
        <div className="overflow-x-auto">
          <table>
            <thead><tr><th>Cookie</th><th>Émetteur</th><th>Finalité</th><th>Durée</th></tr></thead>
            <tbody>
              <tr><td>Cookies de session Calendly</td><td>Calendly</td><td>Permettre la prise de rendez-vous via le widget Calendly intégré au site</td><td>Session</td></tr>
            </tbody>
          </table>
        </div>
        ...
        <p>
          Lors de votre première visite, un bandeau vous permet d'accepter ou de refuser l'ensemble des cookies non essentiels. Vous pouvez à tout moment modifier vos préférences :
        </p>
        <ul>
        ...
        <p>
          La durée de conservation maximale des cookies est de <strong>13 mois</strong> à compter de leur dépôt, conformément aux recommandations de la CNIL. Les données de mesure d'audience elles-mêmes sont conservées au maximum <strong>25 mois</strong>.
        </p>

        <h2>6. Transferts hors UE</h2>
        <p>
          Certains sous-traitants (Google, Microsoft, Calendly) peuvent traiter les données collectées via les cookies en dehors de l'Union européenne, notamment aux États-Unis. Ces transferts sont encadrés par les clauses contractuelles types de la Commission européenne et, le cas échéant, par le Data Privacy Framework.
        </p>

        <h2>7. Vos droits</h2>
        <p>
          Vous disposez de l'ensemble des droits garantis par le RGPD sur les données collectées via cookies. Pour exercer ces droits ou poser une question, écrivez à <strong><a href="mailto:contact@botami-agency.com" className="text-primary hover:underline">contact@botami-agency.com</a></strong>.
        </p>
        <p>
          Pour plus d'information sur la gestion des cookies, consultez le site de la CNIL : <a href="https://www.cnil.fr/fr/cookies-et-traceurs" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">www.cnil.fr/fr/cookies-et-traceurs</a>.
        </p>
      </div>
    </main>
    <Footer />
