      ...
      <div className="container-wide max-w-3xl mx-auto prose prose-headings:font-heading prose-headings:text-foreground prose-p:text-muted-foreground prose-li:text-muted-foreground prose-strong:text-foreground">
        ...
        <div className="overflow-x-auto">
          <table>
            ...
            <tbody>
              <tr>
                <td>Répondre aux demandes de contact et organiser un appel découverte</td>
                <td>Exécution de mesures précontractuelles à votre demande (art. 6.1.b RGPD)</td>
              </tr>
              <tr>
                <td>Établir et suivre une relation commerciale</td>
                <td>Exécution d'un contrat ou intérêt légitime à prospecter (art. 6.1.b et 6.1.f RGPD)</td>
              </tr>
              <tr>
                <td>Mesurer l'audience et améliorer le site (GA4, Clarity)</td>
                <td>Votre consentement, recueilli via le bandeau cookies (art. 6.1.a RGPD)</td>
              </tr>
              <tr>
                <td>Mesurer la performance des campagnes Google Ads</td>
                <td>Votre consentement (art. 6.1.a RGPD)</td>
              </tr>
              <tr>
        ...
        <p>
          Vos données sont accessibles uniquement aux personnes habilitées au sein de BOTA-AG, ainsi qu'aux sous-traitants techniques suivants, qui agissent sur nos instructions :
        </p>
        <ul>
        ...
        <div className="overflow-x-auto">
          <table>
            ...
            <tbody>
              <tr>
                <td>Données de contact et d'échanges commerciaux (prospects)</td>
                <td>3 ans à compter du dernier contact</td>
              </tr>
              <tr>
                <td>Données de clients</td>
                <td>Durée de la relation contractuelle + 5 ans (obligations comptables et commerciales)</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>Données de navigation anonymisées (GA4, Clarity)</td>
                <td>14 mois maximum</td>
              </tr>
              <tr>
                <td>Cookies</td>
                <td>Durée indiquée dans la politique cookies, maximum 13 mois</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <p>
          Pour exercer ces droits, écrivez à <strong><a href="mailto:contact@botami-agency.com" className="text-primary hover:underline">contact@botami-agency.com</a></strong> en précisant votre demande. Une pièce d'identité pourra vous être demandée en cas de doute raisonnable sur votre identité.
        </p>
        ...
        <h2>10. Contact</h2>
        <p>
          Toute question relative à cette politique : <strong><a href="mailto:contact@botami-agency.com" className="text-primary hover:underline">contact@botami-agency.com</a></strong>.
        </p>
      </div>
    </main>
    <Footer />
