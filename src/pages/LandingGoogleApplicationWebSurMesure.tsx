...
const ProcessTimeline = () => {
  ...
  return (
    <div className="relative" ref={timelineRef}>
      <SEO
        title={LP_META["application-web-sur-mesure"].title}
        description={LP_META["application-web-sur-mesure"].description}
        canonical={LP_META["application-web-sur-mesure"].path}
      />
      <StructuredData
        data={[
          serviceSchema({
            name: LP_META["application-web-sur-mesure"].serviceName,
            description: LP_META["application-web-sur-mesure"].description,
            path: LP_META["application-web-sur-mesure"].path,
            serviceType: LP_META["application-web-sur-mesure"].serviceType,
          }),
        ]}
      />
...
const LandingGoogleApplicationWebSurMesure = () => {
  useEffect(() => {
    ...
    if (meta) meta.setAttribute("content", "Application web sur mesure pour entreprises. Accessible partout, forfait 5 000–15 000€, livrée en 4 à 8 semaines, code source à vous.");
  }, []);
    ...
    <div className={body} style={{ backgroundColor: C.bg, color: C.text }}>
      ...
      <section className="px-4 md:px-8 pt-16 pb-20 md:pt-24 md:pb-28">
        <div className="max-w-3xl mx-auto text-center">
          <Reveal><p className="text-sm font-semibold uppercase tracking-widest mb-5" style={{ color: C.amber }}>Application web sur mesure pour entreprises</p></Reveal>
          <Reveal delay={100}><h1 className={`${heading} text-3xl md:text-5xl lg:text-[3.5rem] leading-tight mb-6`}>Votre application web métier, développée sur mesure.</h1></Reveal>
          <Reveal delay={200}><p className="text-lg md:text-xl leading-relaxed mb-10" style={{ color: C.textSec }}>On remplace vos SaaS, vos fichiers Excel et vos outils bricolés par une application web accessible partout, qui fait exactement ce dont vous avez besoin. Code source livré. Prix forfaitaire.</p></Reveal>
      ...
      <LPFormCalendly route="/lp/google/application-web-sur-mesure" title="Réservez votre appel découverte gratuit" subtitle="15-20 minutes pour comprendre votre situation. Sans engagement." />
