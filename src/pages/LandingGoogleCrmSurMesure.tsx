...
const ProcessTimeline = () => {
  ...
  return (
    <div className="relative" ref={timelineRef}>
      <SEO
        title={LP_META["crm-sur-mesure"].title}
        description={LP_META["crm-sur-mesure"].description}
        canonical={LP_META["crm-sur-mesure"].path}
      />
      <StructuredData
        data={[
          serviceSchema({
            name: LP_META["crm-sur-mesure"].serviceName,
            description: LP_META["crm-sur-mesure"].description,
            path: LP_META["crm-sur-mesure"].path,
            serviceType: LP_META["crm-sur-mesure"].serviceType,
          }),
        ]}
      />
