...
const valueProps = [
  {
    ...
    desc: "Cahier des charges, maquette, développement, tests, livraison. On gère tout. Vous validez à chaque étape. Pas de surprise.",
  },
  {
    icon: Settings2,
    title: "Prix fixe, pas de TJM",
    desc: "Entre 5 000€ et 15 000€ selon la complexité. Pas de jours supplémentaires qui traînent. Le prix qu'on annonce est le prix que vous payez.",
  },
  {
    icon: Code2,
    title: "L'application est vôtre",
    desc: "Code source, données, hébergement, accès — tout vous appartient. Pas de dépendance. Vous pouvez en faire ce que vous voulez après.",
  },
  {
    icon: Clock,
    title: "Livrée rapidement",
    desc: "Les 2 premières semaines : cahier des charges + maquette. Puis développement itératif. En production en 4 à 8 semaines.",
  },
];
...
const comparatifRows = [
  { critere: "Modèle de prix", agence: "TJM 500-900€ × jours non plafonnés", botami: "Forfait 5 000-15 000€, une seule fois" },
  { critere: "Propriété du code", agence: "Variable selon le contrat", botami: "Oui, code source remis à la livraison" },
  { critere: "Délai de livraison", agence: "6 à 18 mois (effet tunnel)", botami: "4 à 8 semaines" },
  { critere: "Personnalisation", agence: "Totale mais chaque ajout = devis rallongé", botami: "Conçu sur mesure pour votre métier" },
  { critere: "Dépendance au fournisseur", agence: "Forte (maintenance au TJM)", botami: "Zéro — vous pouvez partir avec tout" },
  { critere: "Coût sur 3 ans", agence: "40 000 à 120 000€", botami: "5 000-15 000€ (payé une fois)" },
];
...
const steps = [
  {
    ...
    time: "1-2 semaines",
    desc: "On pose les bonnes questions. Votre besoin, votre public, vos contraintes. On propose une architecture adaptée. Document précis.",
  },
  {
    num: "02",
    icon: Layers,
    title: "Maquette",
    time: "1-2 semaines",
    desc: "Prototype cliquable complet. Vous testez l'expérience utilisateur. Vous validez avant que le code ne commence.",
  },
  {
    num: "03",
    icon: Hammer,
    title: "Développement",
    time: "4-8 semaines",
    desc: "Code solide, tests réguliers. Versions testables à chaque étape. Vous suivez la progression. Retours intégrés en continu.",
  },
  {
    num: "04",
    icon: PackageCheck,
    ...
    time: "1 semaine",
    desc: "Lancement en production. Formation de votre équipe. Code source et documentation remis. Vous êtes autonomes.",
  },
];
...
const faqs = [
  {
    q: "Vous développez en quelle techno ?",
    a: "On choisit les outils les plus pertinents pour votre cas. Backend solide (Node, Python, etc.), frontend moderne (React, Vue), base de données sécurisée, hébergement français de préférence.",
  },
  {
    q: "Combien de temps avant de voir les premiers résultats ?",
    a: "Maquette en 2 semaines. Premiers prototypes en 4-5 semaines. Livraison finale en 4 à 8 semaines selon la complexité. Vous suivez le chemin.",
  },
  {
    q: "Mon app doit intégrer 3-4 outils externes, c'est possible ?",
    a: "Tout à fait. Les intégrations API, c'est notre métier. On branche Stripe, Zapier, Google Sheets, Salesforce, peu importe. C'est inclus selon le scope.",
  },
  {
    q: "Que se passe-t-il si on trouve un bug après la livraison ?",
    a: "On corrige. Les bugs critiques, on rule, c'est notre responsabilité. Les demandes d'amélioration : discutées ensemble, à coter séparément si hors scope.",
  },
  {
    q: "Aucun lock-in, c'est garanti ?",
    a: "Oui. Code source à vous, données à vous, hébergement à vous. Vous pouvez partir demain avec tout ce qu'on a construit. Aucune dépendance technologique.",
  },
];
...
/* ─── Page ─── */
const LandingGoogleAgenceDevApplication = () => {
  return (
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Reveal delay={100}>
            <h1 className={`${heading} text-3xl md:text-5xl lg:text-[3.5rem] leading-tight mb-6`}>
              On crée votre application de A à Z. Web, mobile, métier.
            </h1>
          </Reveal>
          <Reveal delay={200}>
            <p className="text-lg md:text-xl leading-relaxed mb-10" style={{ color: C.textSec }}>
              Vous avez besoin d'une application. Quel que soit votre cas, on la construit sur mesure — prix forfaitaire, code source livré, 4 à 8 semaines, garantie qualité.
            </p>
          </Reveal>
          <Reveal delay={300}>
            <CTA id="cta-hero" />
        ...
        <div className="max-w-5xl mx-auto">
          <Reveal>
            <h2 className={`${heading} text-2xl md:text-4xl mb-4 text-center`}>
              Agence de dev classique vs Botami Software
            </h2>
            <p className="text-lg text-center mb-14 max-w-2xl mx-auto" style={{ color: C.textSec }}>
              Le forfait tue le syndrome du projet qui n'en finit pas.
            </p>
          </Reveal>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr style={{ backgroundColor: C.bg }}>
                    ...
                    <th className="px-6 py-4 text-sm font-semibold" style={{ color: C.text }}>Agence dev traditionnelle au TJM</th>
                ...
                <tbody>
                  {comparatifRows.map((r, i) => (
                    <tr key={i} className="border-t" style={{ borderColor: "#E5E7EB", backgroundColor: i % 2 === 0 ? C.card : C.bg }}>
                      ...
                      <td className="px-6 py-4 text-sm" style={{ color: C.textSec }}>{r.agence}</td>
              ...
              <Reveal key={i} delay={i * 100}>
                <div className="rounded-xl border p-5" style={{ backgroundColor: C.card, borderColor: "#E5E7EB" }}>
                  ...
                  <div className="space-y-3">
                    <div>
                      <p className="text-xs font-medium mb-1" style={{ color: C.textSec }}>Agence dev traditionnelle</p>
                      <p className="text-sm" style={{ color: C.textSec }}>{r.agence}</p>
                    </div>
        ...
        <div className="max-w-3xl mx-auto">
          <Reveal>
            ...
            <p className="mt-6 text-sm" style={{ color: C.textSec }}>
              Entreprise française. Code source, prix forfaitaire, processus transparent. De l'idée à la production.
            </p>
          </Reveal>
        </div>
      </section>
...
export default LandingGoogleAgenceDevApplication;
